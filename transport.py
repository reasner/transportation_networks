...
water_super_detailed_img_path = os.path.join(cd,r'water_super_detailed_map.png')
...
plt.savefig(water_super_detailed_img_path,bbox_inches='tight',pad_inches=0,dpi=150)
plt.clf()
...
interstate_super_detailed_img_path = os.path.join(cd,r'interstate_super_detailed_map.png')
...
plt.savefig(interstate_super_detailed_img_path,bbox_inches='tight',pad_inches=0,dpi=150)
plt.clf()
#highway picture
fig = plt.figure()
ax = fig.add_axes([0, 0, 1, 1])
...
highway_super_detailed_img_path = os.path.join(cd,r'highway_super_detailed_map.png')
...
plt.savefig(highway_super_detailed_img_path,bbox_inches='tight',pad_inches=0,dpi=150)
plt.clf()
#other road picture
fig = plt.figure()
ax = fig.add_axes([0, 0, 1, 1])
...
other_road_super_detailed_img_path = os.path.join(cd,r'other_road_super_detailed_map.png')
...
plt.savefig(other_road_super_detailed_img_path,bbox_inches='tight',pad_inches=0,dpi=150)
plt.clf()
...
main_rail_super_detailed_img_path = os.path.join(cd,r'main_super_detailed_rail_map.png')
...
plt.savefig(main_rail_super_detailed_img_path,bbox_inches='tight',pad_inches=0,dpi=150)
plt.clf()
#other rail
fig = plt.figure()
ax = fig.add_axes([0, 0, 1, 1])
...
other_rail_super_detailed_img_path = os.path.join(cd,r'other_super_detailed_rail_map.png')
...
plt.savefig(other_rail_super_detailed_img_path,bbox_inches='tight',pad_inches=0,dpi=150)
plt.clf()
